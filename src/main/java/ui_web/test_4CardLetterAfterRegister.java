...
public class test_4CardLetterAfterRegister {
    ...
    public void пользователь_авторизован_и_находится_в_inbox_personal() throws Throwable {
        ...
        //Thread.sleep(5000);
        //driver.findElement(By.id("mobileOrEmail")).sendKeys("rkapranov@mailinator.com");
        //Thread.sleep(5000);
    ...
    public void в_карточке_письма_нажать(String arg1) throws Throwable {
        ...
        Thread.sleep(3000);
        //Добавить скрин
        //driver.findElement(By.linkText("Убрать в архив")).click();
    ...
    public void в_карточке_письма_нажать_на_ссылку(String arg1) throws Throwable {
        ...
        //driver.findElement(By.linkText("Вернуть из архива")).click();
        Thread.sleep(3000);
        driver.navigate().refresh();
        //Добавить скрин
    }
